...
namespace tprotect
{
[[nodiscard]] inline std::expected<std::string, std::string> read_file(const std::string &file_name) noexcept
{
...
[[nodiscard]] inline std::expected<void, std::string> write_file(const std::string &file_name,
...
[[nodiscard]] inline std::optional<std::string> display_file_dialog(const std::string &key) noexcept
{
...
[[nodiscard]] inline std::expected<void, std::string> read_file_dialog(const std::string &key,
                                                                       std::string &content) noexcept
{
    return display_file_dialog(key)
        .and_then([&](const std::string &file_path) -> std::optional<std::expected<void, std::string>> {
...
[[nodiscard]] inline std::expected<void, std::string> write_file_dialog(const std::string &key,
                                                                        const std::string &content) noexcept
{
    return display_file_dialog(key)
        .and_then([&](const std::string &file_path) -> std::optional<std::expected<void, std::string>> {
